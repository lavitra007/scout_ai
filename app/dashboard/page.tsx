...
export default function Home() {
  ...
  if (isLoading || !profile) {
    return <div className="h-screen bg-background flex items-center justify-center font-code-sm text-terminal-lime animate-pulse">INITIALIZING SCOUT KERNEL...</div>;
  }
          ...
          <section className="flex-1 overflow-y-auto p-container-padding border-r border-border-muted bg-surface-dim">
            ...
            <div className="space-y-6 pb-20">
              {loading && missions.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-64 border border-border-muted border-dashed">
                  <p className="font-code-sm text-text-muted text-center max-w-sm">
                    NO INTELLIGENCE FOUND FOR THE CURRENT PROFILE.
                  </p>
                </div>
              ) : (
